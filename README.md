...
```
cd existing_repo
git remote add origin https://gitlab.aws.dev/skoppar/rescale-bedrock-kb.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.aws.dev/skoppar/rescale-bedrock-kb/-/settings/integrations)
...
>>>>>>> 30960cd (Rescale testing for KB performance)
